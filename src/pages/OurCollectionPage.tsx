...
const allProducts = [
  ...
  },
  {
    ...
    price: "$60",
    image: "src/assets/outwearmensleather.jpg",
    category: "Out Wear",
  },
  {
    id: 13,
...
const OurCollectionPage = () => {
  ...
  ].slice(0, 4); // Always limit to 4 products
    ...
    <div className="min-h-screen">
      <section className="py-24 md:py-32 bg-white min-h-screen">
        <div className="max-w-8xl mx-auto px-6 md:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-16 md:mb-20">
            OUR COLLECTION
          </h2>

          {/* Category Buttons */}
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 mb-20 md:mb-24">
...
export default OurCollectionPage;
